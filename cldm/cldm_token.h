...
#define cldm_probe_noreturn__Noreturn() cldm_generic_probe()
#define cldm_probe_noreturn_noreturn() cldm_generic_probe()

#define cldm_match_token(token, x) cldm_chk(cldm_expand(cldm_cat_expand(cldm_cat_expand(cldm_cat_expand(cldm_probe_,token),_),x))())
...
#define cldm_token_noreturn(x) cldm_match_token(noreturn,x)
